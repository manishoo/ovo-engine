...
import { MealType, Pagination, Ref, WeightMeasurement, ObjectId, WeightMeasurementInput } from '@Types/common'
...
export class BodyMeasurementInput {
  ...
  @Field(type => WeightMeasurementInput)
