...
// import FoodGroupTr from '~/models/foods/food-group-translation.model'
...
// import { fndds } from '../src/config/connections/sequelize'
// import { foodDesAttribute, weightAttribute } from '../src/models/_fndds-models/db'
//
...
// 		fa: 'وعده های غذایی، نوشیدنی ها و غذاهای جانبی',
// 		image_url: ''
// 	},
...
// 		fa: 'مواد غذایی بومی آلاسکا و آمریکایی/هندی',
// 		image_url: ''
// 	},
